...
local textToCopy = "https://link-target.net/1339131/iyc-hub-keysystem"
...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      ...
      Key = {"https://pastebin.com/raw/A11PK604"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
local Button = SilentAimTab:CreateButton({
    ...
    Callback = function()
        ...
        local HITBOX_COLOUR = Color3.fromRGB(75,255,255) -- Default colour (RGB)
